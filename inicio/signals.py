...
# Signal desactivado - la lógica está en adapters.py (GoogleSocialAccountAdapter)
# El adaptador maneja automáticamente:
# - Conectar usuarios existentes por email
# - Crear el perfil de UsuarioGoogle
# - Poblar datos del usuario desde Google

# @receiver(social_account_updated)
# def actualizar_perfil_google(sender, socialaccount, **kwargs):
